...
export default function ComplaintsPage() {
  return (
    <div className="mx-auto max-w-[720px] px-5 py-16 sm:px-8">
      <h1 className="text-[length:var(--text-h1)] leading-[1.12]">Complaints</h1>
      <div className="text-foreground mt-10 flex flex-col gap-6 text-base leading-relaxed">
        ...
        <p>
          Email{' '}
          <a href="mailto:complaints@doorstep.co.uk">complaints@doorstep.co.uk</a>{' '}
        ...
        <p>
          ...
          resolution. Serious concerns about listing content can also be reported
          in-product via &ldquo;Report this listing&rdquo; on the property page.
        </p>

        <h2 className="text-[length:var(--text-h3)]">Data protection complaints</h2>
        <p>
          For privacy-related complaints, contact{' '}
          <a href="mailto:privacy@doorstep.co.uk">privacy@doorstep.co.uk</a>.
          You have the right to refer matters to the ICO if you are not satisfied
          with our response.
        </p>
